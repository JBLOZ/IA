...
#FUNCION QUE RECORRE CADA LINEA DE CADA ARCHIVO Y GUARDA LAS STRINGS CONFORME A
#LAS CLAVES QUE HAYA GUARDADAS EN EL DICCIONARIO CON LOS VALORES EN FORMA DE LISTA
def leerArchivos():
...
#FUNCION QUE ESCRIBE CADA VALOR DEL DICCIONARIO DE LISTAS DE CLIENTES Y
#LAS SOBRE ESCRIBE EN LOS FICHEROS LINEA POR LINEA
