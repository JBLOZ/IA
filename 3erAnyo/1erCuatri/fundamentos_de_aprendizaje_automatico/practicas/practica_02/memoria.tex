...
\textbf{Validación Cruzada:} 5-fold estratificada solo en entrenamiento para optimizar hiperparámetros (bandwidth en Parzen, k en k-NN).

\textbf{Métricas:} F1-macro (métrica principal por desbalance), accuracy, precision, matrices de confusión.
...
He evaluado los seis modelos en el conjunto de prueba de 21 muestras. Las \cref{tab:results_cv,tab:results_test} muestran los resultados de validación cruzada y test respectivamente, separando modelos paramétricos (1-2) de no paramétricos (3-6).
...
El desbalance original (meanIR=4.84) expone brutalmente debilidades de modelos complejos: MLE Full no puede estimar covarianzas con 3-5 ejemplos/clase, clasificando anfibios como mamíferos. El balanceo sintético (101→287 instancias) transforma MLE Full dramáticamente:\linebreak
