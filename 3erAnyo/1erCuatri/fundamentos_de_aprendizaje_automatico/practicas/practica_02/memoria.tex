...
\begin{abstract}
Este trabajo aborda la práctica 2 en la asignatura de Fundamentos del Aprendizaje Automático empleando el dataset Zoo de UCI, aplicando los algoritmos requeridos y analizando sus resultados en una tarea real de clasificación con múltiples clases y características binarias. Se comparan seis modelos diferentes siguiendo estrictamente los contenidos de teoría (T2-T4).
\end{abstract}
...
\begin{itemize}
    ...
    \item \textbf{Aplicación directa de teoría:} Permite implementar y comparar tanto métodos paramétricos (T2) como no paramétricos (T4) en un contexto real y bien documentado.
\end{itemize}
