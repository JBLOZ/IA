...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\columnwidth]{tsne_dataset.pdf}
\caption{Disposición del dataset}
\label{fig:tsne}
En la anterior figura podemos ver como estan configurados los clusters de las clases de animales respecto a sus caracteristicas usando embedings no lineales.
\end{figure}
