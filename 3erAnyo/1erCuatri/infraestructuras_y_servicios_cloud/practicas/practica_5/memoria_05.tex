...
Finalmente en los registros de cloudWatch podemos ver las invocaciones a la función mas recientes.
	...
	\subsection{Preparación del Entorno de Datos}

	\subsubsection{Subida del Dataset a S3}


	\subsubsection{Verificación de la Estructura del Dataset}


	\subsection{Configuración de AWS Glue}

	\subsubsection{Creación de la Base de Datos en Glue}


	\subsubsection{Configuración del Crawler}


	\subsubsection{Ejecución del Crawler y Validación del Esquema}


	\subsection{Transformación ETL con AWS Glue}

	\subsubsection{Creación del Job ETL}


	\subsubsection{Configuración del Script de Transformación}


	\subsubsection{Ejecución del Job y Almacenamiento de Datos Procesados}


	\subsection{Consultas y Análisis con Amazon Athena}

	\subsubsection{Configuración de Athena}


	\subsubsection{Consultas SQL sobre los Datos Originales}


	\subsubsection{Consultas SQL sobre los Datos Transformados}
