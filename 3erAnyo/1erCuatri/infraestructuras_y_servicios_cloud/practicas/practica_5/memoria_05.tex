...
\end{itemize}
	...
	\subsection{Simulación de Telemetría con Node-RED}
		...
		\begin{itemize}
			\item \textbf{Inject (timestamp):} Un disparador manual para iniciar el flujo, cada 10 segundos se envia una señal al siguiente nodo para que mande un mensaje.
