...
node aws-iot-device-sdk-js-v2\samples\node\mqtt\mqtt5_x509\index.js --endpoint a1paa0c5brn8mp-ats.iot.us-east-1.amazonaws.com --key farolasestado.private.key --cert farolasestado.cert.pem --client_id sdk-nodejs-v2 --topic sdk/test/js