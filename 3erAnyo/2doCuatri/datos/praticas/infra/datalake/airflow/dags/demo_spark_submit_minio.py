...
HOST_JOBS_DIR = r"/Users/jordiblascolozano/Documents/IA/3erAnyo/2doCuatri/datos/praticas/infra/datalake/jobs"  # <- ajusta si tu ruta difiere

# Ruta del spark-defaults en tu host (Windows)
HOST_SPARK_DEFAULTS = r"/Users/jordiblascolozano/Documents/IA/3erAnyo/2doCuatri/datos/praticas/infra/datalake/spark/conf/spark-defaults.conf"
